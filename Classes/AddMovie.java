...
public class AddMovie extends Movie{
	...
	public AddMovie(int sl, String name, int year, double rating, String genre, double duration){
		super(name, year, rating, genre, duration);
		this.sl=sl;
	}
	...
	public void showMovie(){
		...
		System.out.println();
		System.out.println("          "+"[ SERIAL NUMBER: "+sl+" ]");
		showMovieDetails();
		System.out.println("________________________________________");
		System.out.println();
	}
